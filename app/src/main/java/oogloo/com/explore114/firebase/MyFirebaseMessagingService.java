package oogloo.com.explore114.firebase;
...
import oogloo.com.explore114.R;
import oogloo.com.explore114.firebasenotification;

/**
 * Created by FahAd SheIkH on 9/7/2017.
 */
...
////                    .setContentIntent(pushNotification)
//                    .build();
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), firebasenotification.class);
